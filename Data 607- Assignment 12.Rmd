...
flights_db <- dbConnect(MySQL(), user='root', password='Data607!', dbname='flights', host='127.0.0.1')
...
graph <- startGraph("http://localhost:7474/db/data/", username = "data607", password = "data607")
